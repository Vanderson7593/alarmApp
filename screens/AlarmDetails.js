...
import { getAlarmById, getAlarmsList } from '../redux/selectors';
import { useSelector } from 'react-redux'
const moment = require('moment');


const AlarmDetails = ({ getAlarm, store, navigation, dispatch, route }) => {
        ...
        function renderVolume() {
            return (
                ...
                >
                    ...
                    <View
                        style={{ marginVertical: SIZES.padding2 }}
                    >
                        <Slider
